...
SELECT TOILET_ID, DISTANCE FROM (SELECT ROUND(DISTANCE_WGS84(37.56705301262327, 126.9664894134985, LOC_Y, LOC_X), 3) DISTANCE, TOILET_VIEW.* FROM TOILET_VIEW ORDER BY 1 ASC) WHERE ROWNUM <= 15;

-- TOILET_ID 중복 있나 체크
SELECT COUNT(*) FROM TOILET_VIEW GROUP BY TOILET_ID HAVING COUNT(*) >= 2;

-- Marker 구분을 위한 정리
SELECT DETAIL_CONTENT3 FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' GROUP BY DETAIL_CONTENT3; -- 총 null 포함 41개

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 IS NULL; -- 13개 이거 처리해줘도 나쁘진 않을듯
-- 나누리병원 - 병원, 경남1차상가 - 상가, 나머지 - 빌딩
UPDATE TOILET_VIEW SET DETAIL_CONTENT3 = '병원' WHERE LOCATION_NAME = '나누리병원';
UPDATE TOILET_VIEW SET DETAIL_CONTENT3 = '상가' WHERE LOCATION_NAME = '경남1차상가';
UPDATE TOILET_VIEW SET DETAIL_CONTENT3 = '빌딩' WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 IS NULL;
COMMIT;

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '빌딩'; -- 543개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '아크릴전문기업'; -- 1개 최가빌딩
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '기타'; -- 1개 국제아케이트
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '택시회사'; -- 2개

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '상가(전통시장)'; -- 48개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '상가(재래시장)'; -- 18개 상가, 시장
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '시장(상가)'; -- 1개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '상가(시장)'; -- 148개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '전통시장'; -- 1개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '재래시장'; -- 1개

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '민간'; -- 롯데리아 같은 음식점 의미
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '음식점'; -- 35개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '상가'; -- 6개 음식점, 상가, 성당도 1개 있음?
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '지하상가'; -- 6개

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '공공시설'; -- 자치회관 3개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '공공청사(임시)'; -- 1개 주민센터
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '공공청사'; -- 950개 주민센터, 파출소, 보건소, 우체국, 기념관, 소방서, 관리공단 등등
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '공용시설'; -- 410개 체육시설, 복지관, 경로당, 문화센터

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '장례식장'; -- 1개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '예식장'; -- 4개

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '정교시설'; -- 교회 1개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '종교시설'; -- 36개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '교회'; -- 3개

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '병원'; -- 61개

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '문화시설'; -- 2개 극장, 진흥원
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '전시관'; -- 1개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '도서관'; -- 1개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '박물관'; -- 2개

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '학교'; -- 165개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '대학교'; -- 4개

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '체육시설'; -- 2개 야구공원
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '근린공원'; -- 1개 공원
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '공원'; -- 815개

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '화장실'; -- 화장실 191개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '공중화장실'; -- 5개

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '지하철'; -- 313개
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '철도역'; -- 15개 서울역 같은거

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '교통시설'; -- 77개 환승센터, 공영주차장
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME3 = '소재지용도' AND DETAIL_CONTENT3 = '주차장'; -- 6개
...
SELECT DETAIL_CONTENT4 FROM TOILET_VIEW WHERE DETAIL_NAME4 = '소재지용도' GROUP BY DETAIL_CONTENT4; -- 없음
SELECT DETAIL_CONTENT2 FROM TOILET_VIEW WHERE DETAIL_NAME2 = '소재지용도' GROUP BY DETAIL_CONTENT2; -- 없음

SELECT * FROM TOILET_VIEW;

SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME1 != '시설구분';
SELECT COUNT(*) FROM TOILET_VIEW WHERE DETAIL_NAME1 != '시설구분'; -- 4508
SELECT * FROM TOILET_VIEW WHERE DETAIL_NAME1 = '시설구분';
